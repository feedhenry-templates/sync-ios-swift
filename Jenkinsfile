...
/*
PROJECT_NAME = params?.PROJECT_NAME?.trim()                         // e.g. "sync-ios-swift"
INFO_PLIST = params?.INFO_PLIST?.trim()                             // e.g. "sync-ios-swift/sync-ios-swift-Info.plist"
VERSION = params?.APP_VERSION?.trim()                               // e.g. "0.1-alpha"
SHORT_VERSION = params?.APP_SHORT_VERSION?.trim()                   // e.g. "0.1"
BUNDLE_ID = params?.BUNDLE_ID?.trim()                               // e.g. "com.feedhenry.sync-ios-swift"
